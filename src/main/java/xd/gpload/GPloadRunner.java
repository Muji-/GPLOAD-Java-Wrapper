...
public class GPloadRunner {
    ...
    protected static ArrayList<String> executeCommand(String command) {
    ...
    protected static String checkGPloadOutputForErrors(ArrayList<String> output) {
        String errMsg = "";
